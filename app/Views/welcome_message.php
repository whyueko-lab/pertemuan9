...
<head>
    <meta charset="UTF-8">
    <title>Selamat Datang Para Gamers</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di WEB Undira</h1>
...
<section>
    ...
    <p>Nama: Wahyu Eko Suroso</p>

    <p>Alamat: Bekasi</p>

    <p>Bahasa Pemrograman yang di sukai :PHP</p>

    <p>Database yang di sukai : MySQL</p>
